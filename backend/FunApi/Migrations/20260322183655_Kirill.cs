...
{
    /// <inheritdoc />
    public partial class Kirill : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdvertisementStatusId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvertisementModerations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdvertisementModerations_Advertisements_AdvertisementId",
                        column: x => x.AdvertisementId,
                        principalTable: "Advertisements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdvertisementModerations_Users_ModeratorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartItems_Advertisements_AdvertisementId",
                        column: x => x.AdvertisementId,
                        principalTable: "Advertisements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvertisementModerations_AdvertisementId",
                table: "AdvertisementModerations",
                column: "AdvertisementId");

            migrationBuilder.CreateIndex(
                name: "IX_AdvertisementModerations_ModeratorId",
                table: "AdvertisementModerations",
                column: "ModeratorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_AdvertisementId",
                table: "CartItems",
                column: "AdvertisementId");

            migrationBuilder.CreateIndex(
                name: "IX_CartItems_CartId_AdvertisementId",
                table: "CartItems",
                columns: new[] { "CartId", "AdvertisementId" },
                unique: true);
